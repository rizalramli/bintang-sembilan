    ...
    <div class="row">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-sm-3 mb-1">   
                        {!! Form::label('filter_customer', 'Filter Customer') !!}
                        {!! Form::select('filter_customer', $customer, null, ['class' => 'select2 form-control','id' => 'filter_customer']) !!}
                    </div>
                    <div class="form-group col-sm-3 mb-1">   
        ...
        <div class="card">
            <div class="card-body p-0">
                @include('transaction::outcoming_woods.table')
