...
class ExpenseDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'transaction::expenses.datatables_actions')
        ->editColumn('date', function ($data) {
            return Human::dateFormat($data->date);
        })
        ->editColumn('amount', function ($row) {
            return '<div style="text-align:right">' . Human::createFormatRupiah($row->amount) . '</div>';
        })
    ...
    public function query(Finance $model)
    {
        ...
        return ExpenseRepository::getData($param);
    }
            ...
            ->parameters([
                ...
                'buttons'   => [
                    ['text'     => '<i data-feather="plus"></i> Tambah Data',
                        ...
                        'action'    => 'function() { window.location = "' . route('expenses.create')  . '"; }',
                    ],
                ],
