...
class IncomeDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'transaction::incomes.datatables_actions')
    ...
    public function query(Finance $model)
    {
        ...
        return IncomeRepository::getData($param);
    }
            ...
            ->parameters([
                ...
                'buttons'   => [
                    ['text'     => '<i data-feather="plus"></i> Tambah Data',
                        ...
                        'action'    => 'function() { window.location = "' . route('incomes.create')  . '"; }',
                    ],
                ],
