...
class IncomingWoodTradeDataTable extends DataTable
{
    /**
    ...
    public function query(IncomingWood $model)
    {
        ...
        return IncomingWoodTradeRepository::getData($param);
    }
            ...
            ->parameters([
                ...
                'buttons'   => [
                    ['text'     => '<i data-feather="plus"></i> Tambah Data',
                        ...
                        'action'    => 'function() { window.location = "' . route('incomingWoodTrades.create')  . '"; }',
                    ],
                ],
    ...
    {
        return 'incoming_wood_trades_datatable_' . time();
    }
}
