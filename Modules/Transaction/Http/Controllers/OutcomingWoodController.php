...
class OutcomingWoodController extends AppBaseController
{
    ...
    public function store(CreateOutcomingWoodRequest $request)
    {
        ...
        $nett = Human::removeFormatRupiah($input['nett']);
        $fare_truck = Human::removeFormatRupiah($input['fare_truck']);
        $fee = Human::removeFormatRupiah($input['fee']);
        $result = Human::removeFormatRupiah($input['result']);

        $input['nett'] = $nett;
        $input['fare_truck'] = $fare_truck;
        $input['fee'] = $fee;
        $input['result'] = $result;
