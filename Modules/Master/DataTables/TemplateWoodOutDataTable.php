...
class TemplateWoodOutDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'master::template_wood_outs.datatables_actions')
     ...
     *
     * @param \App\Models\TemplateWoodOut $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(TemplateWoodOut $model)
    {
            ...
            ->parameters([
                ...
                'buttons'   => [
                    ['text'     => '<i data-feather="plus"></i> Tambah Data',
                        ...
                        'action'    => 'function() { window.location = "' . route('templateWoodOuts.create')  . '"; }',
                    ],
                ],
    ...
    {
        return 'template_wood_outs_datatable_' . time();
    }
}
