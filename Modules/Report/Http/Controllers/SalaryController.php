...
class SalaryController extends AppBaseController
{
    public function index()
    {
        ...
        return view('report::salaries.index', $data);
    }
    ...
    public function excel()
    {
        ...
        $query = SalaryRepository::getReport($param);
        ...
        $title = 'Laporan Penggajian di '.$warehouse_name. '-'. $param['get_by_month'] . '-' . $param['get_by_year'];
        
        return Excel::download(new TemplateExcel($query, new Salary), $title.'.xlsx');
    }
}
