...
@canany(['laporan-log sengon masuk','laporan-balken keluar','laporan-limbah pabrik','laporan-operasional','laporan-hasil dan laba','laporan-penyewaan truk','laporan-kehadiran','laporan-pembelian gudang luar'])
<li>
    <a class="dropmenu d-flex align-items-center" target="_self" href="#">
